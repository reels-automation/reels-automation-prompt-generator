...
class TestTema(unittest.TestCase):
    ...
    def test_sanitize_attribute(self):
        ...
        tema = Tema("¡Bienvenido al mundo del código! @#$", "Homero Simpson @#@", "Matt Groening* ")
    ...
    def test_special_characters(self):
        ...
        tema = Tema("Texto con caracteres especiales áéíóú", "Personaje_@!#", "Autor#_123")
    ...
    def test_tema_con_personaje_sin_author(self):
        ...
        tema = TemaDirector.build_tema_con_personaje_sin_author("Tema Principal", "Homero Simpson")
    ...
    def test_tema_con_personaje_y_author(self):
        ...
        tema = TemaDirector.build_tema_con_personaje_y_author("Tema Principal", "Homero Simpson", "Matt Groening")
        self.assertEqual(tema.tema, "Tema Principal")
        self.assertEqual(tema.personaje, "Homero Simpson")
        self.assertEqual(tema.author, "Matt Groening")
    ...
    def test_tema_con_caracteres_especiales(self):
        ...
        tema = TemaDirector.build_tema_con_personaje_sin_author("Tema @123", "Homero-Simpson!")
        self.assertEqual(tema.tema, "Tema  123")  # El nombre del tema debería estar sanitizado
        self.assertEqual(tema.personaje, "Homero-Simpson!")  # El personaje también debería ser sanitizado
